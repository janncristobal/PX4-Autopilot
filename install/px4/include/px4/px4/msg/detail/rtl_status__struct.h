...
#ifndef PX4__MSG__DETAIL__RTL_STATUS__STRUCT_H_
#define PX4__MSG__DETAIL__RTL_STATUS__STRUCT_H_
...
enum
{
  px4__msg__RtlStatus__RTL_STATUS_TYPE_NONE = 0
};
...
enum
{
  px4__msg__RtlStatus__RTL_STATUS_TYPE_DIRECT_SAFE_POINT = 1
};
...
enum
{
  px4__msg__RtlStatus__RTL_STATUS_TYPE_DIRECT_MISSION_LAND = 2
};
...
enum
{
  px4__msg__RtlStatus__RTL_STATUS_TYPE_FOLLOW_MISSION = 3
};
...
enum
{
  px4__msg__RtlStatus__RTL_STATUS_TYPE_FOLLOW_MISSION_REVERSE = 4
};

/// Struct defined in msg/RtlStatus in the package px4.
typedef struct px4__msg__RtlStatus
{
...
// Struct for a sequence of px4__msg__RtlStatus.
typedef struct px4__msg__RtlStatus__Sequence
{
  px4__msg__RtlStatus * data;
  /// The number of valid items in data
  size_t size;
  /// The number of allocated items in data
  size_t capacity;
} px4__msg__RtlStatus__Sequence;

#ifdef __cplusplus
}
#endif

#endif  // PX4__MSG__DETAIL__RTL_STATUS__STRUCT_H_
